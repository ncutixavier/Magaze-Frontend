...
export class GetShops extends Component {
        ...
        return (
            <div className="pt-4">
                ...
                <MaterialTable
                    ...
                    data={[
                        { name: 'Lorem Ipsum', category: 'Supermarket', location: 'Kigali', contact: '+250788888999', owner: 'Ncuti Xavier', manager: 'Ncuti Xavier' },
                        { name: 'Lorem Ipsum', category: 'Supermarket', location: 'Kigali', contact: '+250788888999', owner: 'Ncuti Xavier', manager: 'Ncuti Xavier' },
                        { name: 'Lorem Ipsum', category: 'Supermarket', location: 'Butare', contact: '+250788888555', owner: 'Ncuti Xavier', manager: 'Ncuti Xavier' },
                        { name: 'Lorem Ipsum', category: 'Supermarket', location: 'Butare', contact: '+250788222999', owner: 'Ncuti Xavier', manager: 'Ncuti Xavier' },
                    ]}
                    actions={[
                        {
...
export default connect(mapStateToProps, mapDispatchToProps)(GetShops)
